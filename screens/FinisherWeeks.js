...
const FinisherWeeks = ({ navigation, route }) => {
      ...
      <TouchableOpacity
        ...
        <Text style={styles.buttonText}>back</Text>
         ...
         <TouchableOpacity
           ...
           onPress={feeding}
         >
           <Text style={styles.buttonText}>21 - 23 Weeks</Text>
         </TouchableOpacity>
         ...
         <TouchableOpacity
           ...
           onPress={feeding}
         >
           <Text style={styles.buttonText}>24 - 26 Weeks</Text>
         </TouchableOpacity>
         ...
         <TouchableOpacity
           ...
           onPress={feeding}
         >
           <Text style={styles.buttonText}>27 - 28 Weeks</Text>
         </TouchableOpacity>
        <TouchableOpacity
          accessibilityRole="button"
          style={styles.button}
          onPress={() => navigation.navigate('Schedule', { previousScreen: 'Finisher' })}
        >
